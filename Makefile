...
.vep: .perl
	mkdir src/vepcache/ && cd src/vep/ && export PERL5LIB=${PBASE}/src/perl/lib/perl5/:${PBASE}/src/perl/lib/5.24.0/ && export PATH=${PBASE}/src/perl/bin:${PATH} && perl INSTALL.pl -a acp -s homo_sapiens -y GRCh37 -v 87 -c ${PBASE}/src/vepcache -g Blosum62,CSN,Conservation,Downstream,ExAC,GO,GXA,LoFtool,NearestGene,TSSDistance,UpDownDistance,miRNA -t && cd ../../ && touch .vep
